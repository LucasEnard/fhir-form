...
thisService.createQQRObs = function (q, qr, obsArray, qExists) {
  ...
  if (qExists)
    ...
    return thisService.fhir.create(q,{headers: {'Content-Type': 'application/json+fhir'}}).then((qResp)=>{
...
thisService.createQR = function (qrData, qData) {
  ...
  return thisService.fhir.create(qrData,{headers: {'Content-Type': 'application/json+fhir'}});
};
